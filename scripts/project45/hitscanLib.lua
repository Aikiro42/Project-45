...
function hitscanLib:chainScan(scanLength, ignoresTerrain, punchThrough, scanUntilCursor)
    local firstHit = self:hitscan(true, {0, 0}, false, 0, scanLength, ignoresTerrain, 0, scanUntilCursor, 0, self:firePosition(), true)
...
function hitscanLib:fireBeam()
    ...
    do
      ...
      hitreg = self:hitscan(true, {0, 0}, false, nil, self.beamParameters.range, ignoresTerrain, punchThrough, self.beamParameters.scanUntilCursor)
      beamStart = hitreg[1]
      beamEnd = hitreg[2]
...
function hitscanLib:hitscan(isLaser, offset, zero, degAdd, scanLength, ignoresTerrain, punchThrough, scanUntilCursor, spread, hitscanLineOrigin, chain, smartScanParameters)
  ...
  local fullHitscanLineDestination = not ignoresTerrain and world.lineCollision(zero and self:firePosition() or hitscanLineOrigin, hitscanLineDestination, {"Block", "Dynamic"}) or hitscanLineDestination
