...
function apply(input, augment)
    ...
    if augment then
        ...
        if augment.primaryAbility then
            ...
            if augment.primaryAbility.laser then
                ...
                if laser and laser.enabled then
                    ...
                    if laser.color and augment.primaryAbility.laser.value.color then
                        laser.color =
                            project45util.moreVividColor(laser.color, augment.primaryAbility.laser.value.color)
                    end
            ...
            local statModParameters = {"baseDamage", "cockTime", "cycleTime", "chargeTime", "overchargeTime",
                                       "fireTime", "reloadCost", "critChance", "critDamageMult", "jumpHeightFactor",
        ...
        if augment.sprite then
            ...
            newAnimationCustom.animatedParts.parts[augment.slot].properties.image = augment.sprite.image ..
                                                                                        flipDirective .. "<directives>"
            ...
            if augment.sprite.imageFullbright then
                ...
                newAnimationCustom.animatedParts.parts[augment.slot .. "Fullbright"].properties.zLevel = (augment.sprite
                                                                                                             .zLevel or
                                                                                                             0) + 1
                newAnimationCustom.animatedParts.parts[augment.slot].properties.centered = true
                newAnimationCustom.animatedParts.parts[augment.slot].properties.transformationGroups = {"weapon"}
